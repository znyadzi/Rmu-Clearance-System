...
$sql="SELECT COUNT(table_id) FROM registry_graduating_class";
...
$sql="SELECT COUNT(table_id) FROM cleared_students ";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($result);
                      ...
                      <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            ...
                            <a href="../view_students"><div class="dashboard-progress dashboard-progress-1 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-account icon-md absolute-center text-dark"></i></div></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h3 class="mb-2 text-dark font-weight-normal">All Blacklisted Students</h5><br /><br /><br />
                            <h2 class="mb-4 text-dark font-weight-bold"><?php echo($blacklisted_students) ?></h2>
                            <a href="../view_blacklisted_students"><div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-cancel icon-md absolute-center text-dark"></i></div></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h3 class="mb-2 text-dark font-weight-normal">All Cleared Students </h5><br /><br /><br />
                            <h2 class="mb-4 text-dark font-weight-bold"><?php echo($cleared_students) ?></h2>
                            <a href="../view_cleared_students"><div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-check icon-md absolute-center text-dark"></i></div></a>
                          </div>
                        </div>
                      </div>
                    </div>
