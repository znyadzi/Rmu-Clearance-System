...
if(isset($_POST['add']))
{
   ...
   if(empty($index_no)||empty($programme)||empty($department))
   {
   ...
   { 
    ...
    $query="SELECT * FROM registry_graduating_class WHERE index_number='$index_no'";
    ...
    else
    {
      ...
      VALUES ('$index_no', '$programme', '$department')";
...
<html lang="en">
  <head>
    ...
    <title>Add Graduating Class</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Add Graduating Class List </h2>
              <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
                <div class="dropdown ml-0 ml-md-4 mt-2 mt-lg-0">
                  <button class="btn bg-primary" type="button" id="dropdownMenuButton1" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#exampleModal"> Add Single Student</button>
                </div>
              </div>
            </div>
            <div class="row">
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    <label for="exampleInputPassword1">Programme of Study</label>
                                    <input type="text" class="form-control" name="programme" placeholder="Enter Programme of Study" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputPassword1">Department of Student</label>
                                    <input type="text" class="form-control" name="department" placeholder="Enter Department of Student" required>
                                  </div>
                                </div>
                                <div class="modal-footer">
                                  <button type="submit" class="btn btn-primary" name="add">Add Details</button>
                                  </form>
                                </div>
                              </div>
                            </div>
