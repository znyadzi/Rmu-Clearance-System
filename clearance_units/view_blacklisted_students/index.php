...
if(isset($_POST['delete']))
{
    ...
    $sql=  "DELETE FROM blacklisted_students WHERE table_id = $hidden_id";
    $result=mysqli_query($conn,$sql);  
...
<html lang="en">
  <head>
    ...
    <title>View Blacklisted Students</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> View Blacklisted Students </h2>
...
<!--Table goes here -->
                        <?php
                        $sql="SELECT * FROM blacklisted_students WHERE department='$department' ";
                        $result=mysqli_query($conn, $sql);
                        if (!$result) {
                            printf("Error: %s\n", mysqli_error($conn));
                            exit();
                      ...
                      $serial_number=1;
                                    while($row= mysqli_fetch_array($result))
                                   {
                                        ...
                                        <td><button type="submit" class="btn btn-success" name="delete">Clear</button></td>
                                        </form>
                                        <?php
                                        echo "</form></tr>"; 
                                        $serial_number++;
