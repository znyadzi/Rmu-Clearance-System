...
if(isset($_POST['delete']))
{
    ...
    $sql=  "DELETE FROM registry_graduating_class WHERE table_id = $hidden_id";
    $result=mysqli_query($conn,$sql);  
    echo "<script> alert('Action taken successfully'); window.location='index.php' </script> ";  
    exit();
}
...
<html lang="en">
  <head>
    ...
    <title>View Graduating Class</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> View Graduating Class </h2>
...
<!--Table goes here -->
                        <?php
                        $sql="SELECT * FROM registry_graduating_class WHERE std_department='$department'";
                        $result=mysqli_query($conn, $sql);
                        if (!$result) {
                            printf("Error: %s\n", mysqli_error($conn));
                            exit();
                      ...
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Programme Studied</th>
                      ...
                      $serial_number=1;
                                    while($row= mysqli_fetch_array($result))
                                   {
                                        ...
                                        echo "<td>".$row['programme_studied']."</td>";  ?>
                                        <form action="index.php" method="POST" >
                                        <?php echo "<input type=hidden name=id value='".$row['table_id']."' ?>"; ?>   
